...
BUCKET_NAME = "PLACE YOUR INITIAL STATE SMART THINGS DATA BUCKET NAME HERE"
BUCKET_KEY = "SPLACE YOUR INITIAL STATE SMART THINGS DATA BUCKET KEY HERE"
ACCESS_KEY = "PLACE YOUR INITIAL STATE SMART THINGS DATA BUCKET ACCESS KEY HERE"
